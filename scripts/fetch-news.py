...
GENERIC = {"شركه", "مجموعه", "القابضه", "السعوديه", "العربيه", "المتحده", "الوطنيه",
           ...
           # كلمات القطاعات (ملزمة ختم 04-09ب): «ارتفاع استهلاك الكهرباء» كان يُنسب
           # للكهرباء السعودية، و«نمو صادرات المعادن» لمعادن… 11 إسناداً خاطئاً مثبتاً.
           # الأسماء ذات الكلمة الواحدة تنتقل لمسار الاسم الكامل بحد كلمة بلا خسارة تغطية.
           "الكهرباء", "معادن", "المعادن", "للمياه", "المياه", "للزراعه", "الزراعه",
           "التسويق", "البحري", "الدواء", "للتعليم", "التعليم", "الاسماك",
           "للاتصالات", "الاتصالات", "للتمويل", "التمويل"}
